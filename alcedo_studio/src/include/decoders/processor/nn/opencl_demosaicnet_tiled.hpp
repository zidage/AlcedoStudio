...
// mosaic. Each job is packed with reflect-101 addressing and signed gamma into
...
class OpenClDemosaicNetTiledExecutor {
 public:
  ...
  auto operator=(const OpenClDemosaicNetTiledExecutor&) -> OpenClDemosaicNetTiledExecutor& =
      delete;
