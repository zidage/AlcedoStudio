...
class EditorHlsModel : public EditorAdjustmentModelBase {
  Q_OBJECT
  Q_PROPERTY(int activeHueIndex READ activeHueIndex WRITE setActiveHueIndex NOTIFY
                 activeHueIndexChanged)
  ...
  Q_PROPERTY(double hueSmoothness READ hueSmoothness WRITE setHueSmoothness NOTIFY
