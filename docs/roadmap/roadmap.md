...
- [ ] Continue semantic search and AI-assisted tagging work; see the
      [semantic generation plan](alcedo_studio/src/ai/semantic_generation_search_plan.md) and
      [AI sidecar backend plan](alcedo_studio/src/ai/ai_sidecar_backend_plan.md).
