...
Write-Output "  Windows EXE  : alcedo_main.rc -> alcedo_icon.ico (PE RT_ICON, OBJECT_DEPENDS)"
Write-Output "  Windows lnk  : install bin/alcedo_studio_ao.ico for Start Menu / desktop"
